...
def readCamerasFromTransformsCPU(path, transformsfile, white_background, extension=".jpg"):
    cam_infos = []
    ...
    with open(os.path.join(path, transformsfile)) as json_file:
        ...
        for idx, frame in enumerate(frames):
            ...
            size0 = 1600 # These values are the ones used for NuScenes
            size1 = 900
...
def readNerfSyntheticInfoCPU(path, white_background, eval, extension=".jpg"):
    print("Reading Training Transforms")
    train_cam_infos = readCamerasFromTransformsCPU(path, "transforms_train.json", white_background, extension)
    print("Reading Test Transforms")
    test_cam_infos = readCamerasFromTransformsCPU(path, "transforms_test.json", white_background, extension)
...
sceneLoadTypeCallbacks = {
    ...
    "Blender" : readNerfSyntheticInfoCPU
}